      ...
      <div className='header'>
          ...
          <header>
            <div className='header__inner'>
              <div className='header__logo-wrapper'>
                <a className='header__logo' title='Go to homepage' href='#'>
                  <svg
                ...
                <a className='header__helpcenter' title='Home' href='#'>
                  Help Center
                </a>
              </div>
              <div className='header__buttons'>
                ...
                <button
                  className='tcon tcon-menu--xcross'
                  type='button'
              ...
              <div className='header__controls' data-menu=''>
                <div className='header__controls__container'>
                  <div className='search-box-desktop'>
                    <form
                      role='search'
                      className='search-box search-box--desktop'
                      action='#'
                    >
                  ...
                  <button className='btn btn--header btn--toggle-search btn--toggle-search hidden-xs hidden-sm hidden-md hidden'>
                    <span>
                      <i className='fa-sharp fa-solid fa-bars'></i>
                    </span>
                  </button>
                  <a className='btn btn--header submit-a-request' href='#'>
                    Submit a request
                  </a>
        ...
        {isOpen && (
          <div className='topbar'>
            <div className='submit-request'>Submit a Request</div>
